...
<head>
    ...
    <link rel="stylesheet" href="https://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/cache/theme-78026624.css" type="text/css" media="all">
        ...
        <div id="box-currency" class="box-content d-flex">
            <div class="w-100">
                <div class="item-currency current">
                    <a title="British Pound" rel="nofollow" href="https://demo.bestprestashoptheme.com/savemart/en/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=1">British Pound: GBP</a>
                </div>
                <div class="item-currency">
                    <a title="US Dollar" rel="nofollow" href="https://demo.bestprestashoptheme.com/savemart/en/?home=home_3&amp;SubmitCurrency=1&amp;id_currency=2">US Dollar: USD</a>
                </div>
            </div>
        </div>
        ...
        <div id="box-language" class="box-content d-flex">
            <div class="w-100">
                <div class="item-language current">
                    <a href="https://demo.bestprestashoptheme.com/savemart/en/?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/1.jpg" alt="English (English)" width="16" height="11" /><span>English</span></a>
                </div>
                <div class="item-language">
                    <a href="https://demo.bestprestashoptheme.com/savemart/fr/?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/2.jpg" alt="Français (French)" width="16" height="11" /><span>Français</span></a>
                </div>
                <div class="item-language">
                    <a href="https://demo.bestprestashoptheme.com/savemart/es/?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/3.jpg" alt="Español (Spanish)" width="16" height="11" /><span>Español</span></a>
                </div>
                <div class="item-language">
                    <a href="https://demo.bestprestashoptheme.com/savemart/it/?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/4.jpg" alt="Italiano (Italian)" width="16" height="11" /><span>Italiano</span></a>
                </div>
                <div class="item-language">
                    <a href="https://demo.bestprestashoptheme.com/savemart/pl/?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/5.jpg" alt="Polski (Polish)" width="16" height="11" /><span>Polski</span></a>
                </div>
                <div class="item-language">
                    <a href="https://demo.bestprestashoptheme.com/savemart/ar/?home=home_3" class="d-flex align-items-center"><img class="img-fluid mr-2" src="/savemart/img/l/6.jpg" alt="اللغة العربية (Arabic)" width="16" height="11" /><span>اللغة العربية</span></a>
                </div>
            </div>
        </div>
